...
<head>
	...
	<link rel="stylesheet" href="css/b-check-style.css"><!--additiona styling just for form-->
...
<nav class="navbar navbar-default navbar-fixed-top"><!--applies BS nav bar styles and effects-->
	...
	<div class="row blacktop">
		...
		<div class="hidden-xs col-sm-6 phone">
			<p>$CAD <a href="http://www.thecupstore.com"><span class="flag-icon flag-icon-us-tsp"></span></a> <a href="http://www.thecupstore.ca"><span class="flag-icon flag-icon-ca"></span></a> <a href="tel:+18666415900">Toll-Free: 1-866-641-5900</a></p>
		</div>

		<div class="visible-xs col-xs-12 phone"><!--Puts the flags on separate line on mobile-->
			<p>$CAD <a href="http://www.thecupstore.com"><span class="flag-icon flag-icon-us-tsp"></span></a> <a href="http://www.thecupstore.ca"><span class="flag-icon flag-icon-ca"></span></a> </p>
		</div>
	...
	<div class="container">
      <div class="row"><!--This will contain 4 cols on desktop, 2 on mobile-->
      	...
      	<div class="col-xs-12 col-sm-3"><!--contact info-->
      		...
      		<p><strong>The Cup Store</strong><br />155 Dolomite Drive<br />Toronto, ON M3J 2N1<br /><a href="tel:+18666415900">Toll-free: 1-866-641-5900</a><br /><a href="mailto:info@thecupstore.com">Email us here</a></p>
      		...
      		<p><a href="http://thecupstore.com">Visit our U.S. website</a></p>
...
<input type="hidden" name="redirect" value="http://www.thecupstore.ca/enews-success.php">
<input type="hidden" name="errorredirect" value="http://www.thecupstore.ca/enews-fail.php">
