...
<div class="row">
	...
	<img src="images/cup-empty.jpg" class="img-responsive" alt="Empty Cup" title="Empty Cup" />
	</div>

	<div class="col-xs-12 col-sm-6">
	<h1>Oops!</h1>
	<p>Looks like we've experienced an error with your email signup request. Please go back to try again. Double check that you have entered a valid email address. Thanks!</p>
