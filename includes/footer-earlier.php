      ...
      <div class="row"><!--This will contain 4 cols on desktop, 2 on mobile-->
      	...
      	<div class="col-xs-5 col-sm-3"><!--website links-->
      		...
      		<ul>
      			...
      			<li><a href="tcs-sitemap.php">Site Map</a></li>
      		</ul>
      	</div><!--end site links-->
        ...
        <div class="col-xs-12 col-sm-3"><!--email signup-->
        	...
        	<form name="cupnews" method="post" action="scripts/send_form_email.php"><!--this php script is necessary for form to function-->
