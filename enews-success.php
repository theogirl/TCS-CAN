...
<head>
    ...
    <title>Success | The Cup Store</title>
...
<div class="row">
	...
	<img src="images/cup-full.jpg" class="img-responsive" alt="Full Cup" title="Full Cup" />
	</div>

	<div class="col-xs-12 col-sm-6">
	<h1>Success!</h1>
	<h4>Thanks for subscribing to The Cup Store mailing list... watch your inbox for monthly news and specials!</h4>
	<p><a href="products.php">Visit the <strong>Product Menu</strong> to browse our collection</a></p>
	</div>
